import project from '../img/portImages/project.png';
const portfolios = [
    {
        id: 1,
        category: 'MERN',
    ...
    },
    {
        ...
        text: `e-commerce shopping website is a responsive full stack web application, with paypal payment gateway,
    ...
    },
    {
        ...
        text: `Social Media website (Facebook clone) is a full stack application, where user can create post,
